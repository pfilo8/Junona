...
\newenvironment{dedication}
{
	...
	\vspace*{\stretch{11}}% some space at the top
...
\begin{dedication}
	Dla rodziców \\
	za bezgraniczną miłość oraz wsparcie
\end{dedication}
...
$$ \boldsymbol{C} = (C_1, C_2, \dots, C_N) \text{,}$$
...
Ilustracja tak zdefiniowanej macierzy kosztu znajduje się w tabeli \ref{tab:macierz-kosztu}.
\begin{table}[h]
	\begin{center}
		\begin{tabular}{c|c|c}
